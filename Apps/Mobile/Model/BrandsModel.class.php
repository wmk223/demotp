...
class BrandsModel extends BaseModel {
	...
	public function queryBrandsByDistrict(){
	  ...
	  */
	  public function queryBrandsByCat($catId){
	  	 ...
	  	 if(!$list){
		     $sql = "select b.brandId,b.brandName,b.brandIco from __PREFIX__goods_cat_brands cb,__PREFIX__brands b where cb.brandId=b.brandId and catId=".$catId;
	...
	public function indexBrands(){
		return M('Brands')->field('brandId,brandName,brandIco')->ORDER('createTime DESC')->limit(3)->select();
	}
}