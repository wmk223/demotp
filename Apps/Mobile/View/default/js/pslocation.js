...
function chooseCity(cityId,cityName){
	...
	townaContainer.hide();
	$.post(Think.U('Mobile/UserAddress/getShopDistricts'),{areaId2:cityId,shopId:shopId},function(data,textStatus){
...
function chooseArea(areaId,areaName){
	...
	$.post(Think.U('Mobile/UserAddress/getShopCommunitys'),{districtId:areaId,shopId:shopId},function(data,textStatus){
		var json = WST.toJson(data);
