...
$(function () {
    ...
    $("#btnsch").click(function () {
    	...
    	if(searchType==2){
    		window.location = Think.U('Mobile/Shops/toShopStreet','searchType='+searchType+"&keyWords="+$.trim($("#keyword").val()));
    	}else{
    		window.location = Think.U('Mobile/goods/getGoodsList','searchType='+searchType+"&keyWords="+$.trim($("#keyword").val()));;
    	}
