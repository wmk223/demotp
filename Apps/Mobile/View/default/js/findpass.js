		...
		if(WST.SMS_VERFY=='1'){
			...
			layer.open({
			    ...
			    yes: function(index, layero){
			    	...
			    	$.post(Think.U('Mobile/Users/getPhoneVerify'),params,function(data,textStatus){
...
$("#sendEmail").click(function(){
	...
	$.getJSON(Think.U('Mobile/Users/getEmailVerify'), { loginName: $("#loginName").val(), time: Math.random(),userPhone:$("#userPhone").val()},
	          function(data){
	        	layer.close(msg);
	            if (data.status==1){
