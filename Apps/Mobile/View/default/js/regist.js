...
function changeName(){
		var params = {};
			...
			if(params.loginName!="" && params.loginName!="邮箱/用户名/手机号"){
				jQuery.post(Think.U('Mobile/Users/checkLoginName') ,params,function(rsp) {
...
function getVerifyCode(){
		...
		if(WST.SMS_VERFY=='1'){
			...
			html.push('<img style="vertical-align:middle;cursor:pointer;height:39px;" class="verifyImg" src="'+WST.DOMAIN+'/Apps/Mobile/View/default/images/clickForVerify.png" title="刷新验证码" onclick="javascript:getVerify()"/>');
...
function regist(){	
	...
	$.post(Think.U('Mobile/Users/toRegist'),params,function(data,textStatus){
		var json = WST.toJson(data);
		if(json.status>0){
