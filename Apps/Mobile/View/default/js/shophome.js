...
function searchShopsGoods(obj){
	...
	document.location.href = Think.U('Mobile/Shops/toShopMobile',params.join('&'));

}

function searchwst(){
	var goodsName = $.trim($("#goodsName").val());
	window.location = Think.U('Mobile/goods/getGoodsList','searchType=2&keyWords='+encodeURIComponent(goodsName));
}
