...
$(function() {
	...
	span.bind("mouseout", function() {
		timer = setInterval(function() {
			...
			li.eq(index).removeClass("hide");
			index++;
			//$(".wst-slide-items img").lazyload({effect: "fadeIn",failurelimit : 1000,threshold: 200,placeholder:domainURL +'/Apps/Mobile/View/default/images/store_default_signlist.png'});
			if (index >= span.length)
				index = 0;
		}, 4000);
	});
