	...
	showQuickPop = function(type){
		...
		if(type !== prevPopType){
			...
			if(fn && fn.msgtype==1){
				...
				fn.content = "<div class='ibar_plugin_content' style='height:100%;padding-top:100%;padding-left:80px;'><img src='"+domainURL +"/Apps/Mobile/View/default/images/loading.gif' width='20'/>数据加载中...</div>";
...
function removeCartGoods(obj,goodsId,goodsAttrId){
	jQuery.post(Think.U('Mobile/Cart/delCartGoods') ,{goodsId:goodsId,goodsAttrId:goodsAttrId},function(data) {
